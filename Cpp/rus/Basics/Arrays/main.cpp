...
int main() {
  ...
  // Функции, которые работают с каким-то объектом (в этом случае вектору)
  ...
  // Это имеет под собой смысл:
  // Ленина 123 - Ленина 0 = 123
  // Ленина 50 - Ленина 25 = 25
  // Но разность между адресами на две разные улицы смысле не имеет:
  ...
  // "лексикографически", то есть в алфавитном порятке, как в словаре.
  ...
  string str(12, '0');
  // Или можно ничего не указывать:
  string example;
  cin >> str;
  cout << str << endl;

  // Многомерные массивы - это массивы, которые содержат массивы как свой тип.
