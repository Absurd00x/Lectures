...
int main() {
  ...
  // из питона. Если ты пишешь символ &, то изменение x и y затронет
  ...
  cout << point.first << ' ' << point.second << endl;
  cout << endl;
  // С помощью структурных привязок можно ещё удобнее проходиться по мапе:
  cout << "Map contents:" << endl;
