...
int main() {
  ...
  // тип с меньшей точностью приводится к типу с большей точностью
  ...
  // int и long long = long long
  // int и float = float
  // double и float = double
  // signed int и unsigned int = unsigned int
  // char и char = int
  ...
  // Чтобы проверить, что число находится с промежутке нужно написать:
  if (100 <= a && a < 1000) {
    cout << "Number " << a << " has 3 digits" << endl;
  }
