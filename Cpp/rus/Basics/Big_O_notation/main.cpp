...
// Разные функции имеют либо разные названия, либо разные аргументы.
...
// Асимптотика, сложность, "О большое" чего-то - это функция "чего-то",
// зависящая от размера входных данных, которая не меньше, чем это "что-то",
// если её домножить на константу. Обычно стараются найти наименьшую такую функцию.
