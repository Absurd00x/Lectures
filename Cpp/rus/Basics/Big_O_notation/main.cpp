...
// Нужно будет написать #include "bits/stdc++.h"

using namespace std;

// Функция (в математике) - это зависимость одной переменной от другой.
// y = f(x) = k*x + b
// Можно сказать, что это обмен одних значений на другие.
...
// 1 1 2 3 5 8 13 21
// Никогда так не вычисляй числа Фибоначчи
int fib(int n) {
  if (n == 0 || n == 1) {
    return 1;
  }
...
// Обычно стараются найти наименьшую такую границу.
...
//    n^2 = n*n, 2 - не константа, а форма записи)
