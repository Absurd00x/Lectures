...
int main() {
   ...
   * Из этого следует, что можно получить значение k-го бита числа num
   * следующим кодом:
   * bit = (num >> k) & 1
   ...
   * __lg(num) - получить индекс самого старшего единичного бита. Если число равно 0,
   *             то поведение не определено. То есть результат произвольный.
   *
